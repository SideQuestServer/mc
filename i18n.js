...
const TRANSLATIONS = {
  ...
  /* ── Navbar: Mitmachen / Join ───────────────── */
  nav_join:        { de: 'Mitmachen',    en: 'Join' },
  nav_join_build:  { de: 'Server bauen', en: 'Build the Server' },
  nav_join_comm:   { de: 'Community & Kontakt', en: 'Community & Contact' },
  nav_join_imp:    { de: 'Impressum & About', en: 'Legal & About' },
  ...
  srv_cs_status:     { de: '▶ SERVER STATUS', en: '▶ SERVER STATUS' },
  srv_cs_h:          { de: 'SERVER ÖFFNET BALD', en: 'SERVER OPENING SOON' },
  srv_cs_desc:       { de: 'Wir bauen noch – der Server ist fast fertig! Tritt unserem Discord bei um als Erstes informiert zu werden wenn wir öffnen.', en: "We're still building – the server is almost ready! Join our Discord to be the first to know when we open." },
  srv_cs_btn:        { de: '💬 Discord – Als Erstes dabei sein', en: '💬 Discord – Be the First to Know' },
  srv_ip_hidden:     { de: 'Wird bekannt gegeben', en: 'To be announced' },
  srv_motd_soon:     { de: '▶ Server startet bald – stay tuned!', en: '▶ Server starts soon – stay tuned!' },
  srv_perf_h:        { de: 'Performance', en: 'Performance' },

  /* ════════ community.html ════════ */
  com_hero_title:    { de: 'Community & Kontakt', en: 'Community & Contact' },
  com_hero_desc:     { de: 'Stell Fragen, gib Feedback oder melde dich einfach kurz. Wir sind auch auf Discord immer erreichbar.', en: "Ask questions, give feedback, or just say hello. We're always reachable on Discord too." },
  com_cf_h:          { de: 'Kontaktformular', en: 'Contact Form' },
  com_cf_name_lbl:   { de: 'NAME', en: 'NAME' },
  com_cf_name_ph:    { de: 'Dein Name oder Minecraft-Name', en: 'Your name or Minecraft name' },
  com_cf_subject_lbl:{ de: 'BETREFF', en: 'SUBJECT' },
  com_cf_subject_ph: { de: 'Worum geht es?', en: 'What is it about?' },
  com_cf_msg_lbl:    { de: 'NACHRICHT', en: 'MESSAGE' },
  com_cf_msg_ph:     { de: 'Schreib uns alles was du loswerden möchtest...', en: 'Write everything you want to share with us...' },
  com_cf_send_btn:   { de: '📨 Nachricht senden', en: '📨 Send Message' },
  com_cf_dc_btn:     { de: '💬 Direkt via Discord', en: '💬 Directly via Discord' },
  com_cf_note:       { de: 'Öffnet dein E-Mail-Programm mit den Angaben vorausgefüllt.', en: 'Opens your email client with the details pre-filled.' },
  com_cf_success:    { de: '✔ E-Mail-Client geöffnet! Bitte noch absenden.', en: '✔ Email client opened! Please send it.' },
  com_dc_h:          { de: 'Discord Community', en: 'Discord Community' },
  com_dc_name:       { de: 'SideQuestCommunity', en: 'SideQuestCommunity' },
  com_dc_desc:       { de: 'Der schnellste Weg uns zu erreichen. Builder-Bewerbungen, Server-Support, Modpack-Hilfe und Community-Chat – alles in einem.', en: "The fastest way to reach us. Builder applications, server support, modpack help and community chat – all in one." },
  com_dc_btn:        { de: 'Discord beitreten ↗', en: 'Join Discord ↗' },
  com_poll_h:        { de: 'Community-Umfragen', en: 'Community Polls' },
  com_poll_sub:      { de: 'Deine Meinung zählt', en: 'Your opinion matters' },
  com_poll1_q:       { de: 'Welchen Spielstil spielst du hauptsächlich auf Modded-Servern?', en: 'What playstyle do you mainly use on modded servers?' },
  com_poll1_tech:    { de: 'Tech & Automatisierung', en: 'Tech & Automation' },
  com_poll1_magic:   { de: 'Magie & Exploration', en: 'Magic & Exploration' },
  com_poll1_build:   { de: 'Bauen & Deko', en: 'Building & Decoration' },
  com_poll1_all:     { de: 'Alles ein bisschen', en: 'A little of everything' },
  com_poll2_q:       { de: 'Was ist dir auf einem Community-Server am wichtigsten?', en: 'What matters most to you on a community server?' },
  com_poll2_lag:     { de: 'Lag-freies Spielen', en: 'Lag-free gameplay' },
  com_poll2_comm:    { de: 'Nette Community', en: 'Nice community' },
  com_poll2_events:  { de: 'Gemeinsame Events', en: 'Shared events' },
  com_poll2_free:    { de: 'Freiheit beim Spielen', en: 'Freedom to play your way' },
  com_poll_vote:     { de: 'Abstimmen', en: 'Vote' },
  com_poll_coming:   { de: 'Weitere Umfragen folgen', en: 'More polls coming' },
  com_poll_coming_sub:{ de: 'Neue Fragen erscheinen regelmäßig – schau wieder vorbei!', en: 'New questions appear regularly – check back!' },
  com_poll_thanks:   { de: '✔ Danke für deine Stimme! Ergebnisse werden demnächst angezeigt.', en: '✔ Thanks for voting! Results will be shown soon.' },
  com_poll_alert:    { de: 'Bitte wähle eine Antwort aus!', en: 'Please select an answer!' },

  /* ════════ recruit.html ════════ */
  rec_hero_title:    { de: 'Wir suchen Builder!', en: "We're Looking for Builders!" },
  rec_hero_desc:     { de: 'Unser ATM10 Server entsteht gerade – und wir brauchen kreative Köpfe die mitbauen wollen. Deutschsprachig, aktiv und Bock auf Minecraft? Dann bist du dabei.', en: "Our ATM10 server is being built – and we need creative minds to help. German-speaking, active, eager for Minecraft? Then you're in." },
  rec_build_h:       { de: 'Was wir bauen', en: "What We're Building" },
  rec_spawn_name:    { de: 'Spawn-Area', en: 'Spawn Area' },
  rec_spawn_desc:    { de: 'Zentrale Hub für alle Spieler', en: 'Central hub for all players' },
  rec_market_name:   { de: 'Marktplatz', en: 'Marketplace' },
  rec_market_desc:   { de: 'Shop- & Handelsbereich', en: 'Shop & trading area' },
  rec_lobby_name:    { de: 'Welt-Lobby', en: 'World Lobby' },
  rec_lobby_desc:    { de: 'Übergang zwischen Dimensionen', en: 'Transition between dimensions' },
  rec_showcase_name: { de: 'Showcase-Area', en: 'Showcase Area' },
  rec_showcase_desc: { de: 'Vorzeige-Builds der Community', en: 'Showcase builds by the community' },
  rec_tech_name:     { de: 'Tech-Deko', en: 'Tech Deco' },
  rec_tech_desc:     { de: 'Create & AE2 Dekoration', en: 'Create & AE2 decoration' },
  rec_nature_name:   { de: 'Natur-Bauten', en: 'Nature Builds' },
  rec_nature_desc:   { de: 'Terraforming & organische Builds', en: 'Terraforming & organic builds' },
  rec_status_open:   { de: 'OFFEN', en: 'OPEN' },
  rec_status_soon:   { de: 'GEPLANT', en: 'PLANNED' },
  rec_status_done:   { de: 'FERTIG', en: 'DONE' },
  rec_req_h:         { de: 'Was wir suchen', en: "What We're Looking For" },
  rec_req_de_title:  { de: 'Deutschsprachig', en: 'German-speaking' },
  rec_req_de_desc:   { de: 'Unsere Community kommuniziert auf Deutsch. Grundlegende Deutschkenntnisse sind Pflicht.', en: 'Our community communicates in German. Basic German skills are required.' },
  rec_req_art_title: { de: 'Kreativ & stilsicher', en: 'Creative & stylish' },
  rec_req_art_desc:  { de: 'Du hast ein Gefühl für Architektur, Deko und Detailarbeit. Ein paar Screenshots deiner Builds wären super.', en: 'You have a sense for architecture, decoration and detail. A few screenshots of your builds would be great.' },
  rec_req_dc_title:  { de: 'Aktiv im Discord', en: 'Active on Discord' },
  rec_req_dc_desc:   { de: 'Absprachen laufen über Discord. Du bist regelmäßig online und kannst mit dem Team kommunizieren.', en: "Coordination happens via Discord. You're regularly online and can communicate with the team." },
  rec_req_rel_title: { de: 'Zuverlässig', en: 'Reliable' },
  rec_req_rel_desc:  { de: 'Kein 24/7-Job – aber wenn du anfängst, ziehst du es auch durch. Verlässlichkeit ist uns wichtig.', en: "Not a 24/7 job – but if you start, you follow through. Reliability matters to us." },
  rec_req_mc_title:  { de: 'ATM10 Kenntnisse', en: 'ATM10 Knowledge' },
  rec_req_mc_desc:   { de: 'Grundkenntnisse in All the Mods 10 oder ähnlichen Modpacks sind hilfreich, aber kein Muss.', en: 'Basic knowledge of All the Mods 10 or similar modpacks is helpful, but not required.' },
  rec_req_team_title:{ de: 'Teamplayer', en: 'Team Player' },
  rec_req_team_desc: { de: 'Du arbeitest gerne mit anderen zusammen und bist offen für Feedback und Absprachen.', en: 'You enjoy working with others and are open to feedback and coordination.' },
  rec_offer_h:       { de: 'Was wir bieten', en: 'What We Offer' },
  rec_offer_1:       { de: '<strong>Kostenloser Server-Zugang</strong> – Als Builder bist du natürlich auf dem Server dabei, sobald er öffnet.', en: "<strong>Free server access</strong> – As a builder you're on the server as soon as it opens." },
  rec_offer_2:       { de: '<strong>Builder-Rang im Discord</strong> – Erkennbarer Rang + eigener Builder-Channel für Absprachen.', en: '<strong>Builder role on Discord</strong> – Recognizable role + dedicated builder channel for coordination.' },
  rec_offer_3:       { de: '<strong>Kreativfreiheit</strong> – Innerhalb des Konzepts kannst du deinen eigenen Stil einbringen. Kein Copy-Paste.', en: '<strong>Creative freedom</strong> – Within the concept you can bring your own style. No copy-paste.' },
  rec_offer_4:       { de: '<strong>Credit auf der Website</strong> – Deine Builds und dein Name werden hier auf der Community-Seite genannt.', en: '<strong>Credit on the website</strong> – Your builds and name will be mentioned here on the community page.' },
  rec_offer_5:       { de: '<strong>Spaß & Community</strong> – Du baust nicht alleine. Wir sind eine entspannte Gruppe, die gerne gemeinsam spielt.', en: "<strong>Fun & community</strong> – You're not building alone. We're a relaxed group that enjoys playing together." },
  rec_apply_title:   { de: 'Jetzt bewerben', en: 'Apply Now' },
  rec_apply_desc:    { de: 'Die Bewerbung läuft über Discord – einfach beitreten, Builds zeigen und vorstellen. Wir melden uns schnell!', en: "Apply via Discord – just join, show your builds and introduce yourself. We'll get back to you quickly!" },
  rec_step1_lbl:     { de: 'DISCORD BEITRETEN', en: 'JOIN DISCORD' },
  rec_step2_lbl:     { de: '#BUILDER-BEWERBUNG', en: '#BUILDER-APPLICATION' },
  rec_step3_lbl:     { de: 'BUILDS ZEIGEN', en: 'SHOW BUILDS' },
  rec_step4_lbl:     { de: 'FERTIG', en: 'DONE' },
  rec_apply_btn:     { de: '💬 Discord beitreten & bewerben', en: '💬 Join Discord & Apply' },

  /* ════════ impressum.html ════════ */
  imp_hero_title:    { de: 'Impressum & About', en: 'Legal & About' },
  imp_hero_desc:     { de: 'Rechtliche Angaben und ein bisschen mehr über den Menschen hinter SideQuestCommunity.', en: 'Legal information and a little more about the person behind SideQuestCommunity.' },
  imp_about_h:       { de: 'About – SideQuestChris', en: 'About – SideQuestChris' },
  imp_about_tag:     { de: '▶ CONTENT CREATOR · MINECRAFT MODDED', en: '▶ CONTENT CREATOR · MINECRAFT MODDED' },
  imp_about_bio1:    { de: 'Hey! Ich bin Chris – Minecraft-Enthusiast, Modpack-Nerd und Content Creator aus Deutschland. Ich betreibe diese Community-Seite, einen ATM10-Server und erstelle Tutorials rund um Minecraft Mods.', en: "Hey! I'm Chris – Minecraft enthusiast, modpack nerd and content creator from Germany. I run this community site, an ATM10 server, and create tutorials about Minecraft Mods." },
  imp_about_bio2:    { de: 'Mein Schwerpunkt liegt auf technischen Mods wie CC: Tweaked, Create und AE2. Ich liebe es, komplexe Systeme zu erklären und Einsteigern den Einstieg zu erleichtern. Auf YouTube und TikTok teile ich Guides, Showcases und Server-Content.', en: 'My focus is on technical mods like CC: Tweaked, Create and AE2. I love explaining complex systems and making it easier for beginners to get started. On YouTube and TikTok I share guides, showcases and server content.' },
  imp_stat_srv:      { de: 'SERVER SPIELER', en: 'SERVER PLAYERS' },
  imp_imp_h:         { de: 'Impressum', en: 'Legal Notice' },
  imp_imp_tmg:       { de: '§ 5 TMG', en: '§ 5 TMG' },
  imp_h_tmg:         { de: 'ANGABEN GEMÄß § 5 TMG', en: 'INFORMATION PURSUANT TO § 5 TMG' },
  imp_h_contact:     { de: 'KONTAKT', en: 'CONTACT' },
  imp_h_resp:        { de: 'VERANTWORTLICH FÜR DEN INHALT (§ 18 ABS. 2 MSTV)', en: 'RESPONSIBLE FOR CONTENT (§ 18 ABS. 2 MSTV)' },
  imp_h_liability:   { de: 'HAFTUNGSAUSSCHLUSS', en: 'DISCLAIMER' },
  imp_liability_txt: { de: 'Die Inhalte dieser Website wurden mit größtmöglicher Sorgfalt erstellt. Für die Richtigkeit, Vollständigkeit und Aktualität der Inhalte kann jedoch keine Gewähr übernommen werden. Diese Website enthält Links zu externen Websites (YouTube, TikTok, Discord, CurseForge). Auf die Inhalte dieser externen Seiten haben wir keinen Einfluss.', en: 'The contents of this website have been created with the greatest possible care. However, no guarantee can be given for the accuracy, completeness and timeliness of the content. This website contains links to external websites (YouTube, TikTok, Discord, CurseForge). We have no influence over the content of these external pages.' },
  imp_h_copyright:   { de: 'URHEBERRECHT', en: 'COPYRIGHT' },
  imp_copyright_txt: { de: 'Die auf dieser Website erstellten Inhalte und Werke unterliegen dem deutschen Urheberrecht. Minecraft ist ein eingetragenes Markenzeichen von Mojang AB. Diese Website steht in keiner offiziellen Verbindung mit Mojang AB oder Microsoft.', en: 'The content and works on this website are subject to German copyright law. Minecraft is a registered trademark of Mojang AB. This website has no official connection with Mojang AB or Microsoft.' },
  imp_privacy_h:     { de: 'Datenschutz-Hinweis', en: 'Privacy Notice' },
  imp_privacy_txt1:  { de: 'Diese Website verwendet keine Tracking-Cookies und keine Analytics-Dienste. Es werden keine personenbezogenen Daten automatisch erhoben.', en: 'This website does not use tracking cookies or analytics services. No personal data is automatically collected.' },
  imp_privacy_cf:    { de: 'Kontaktformular:', en: 'Contact form:' },
  imp_privacy_txt2:  { de: 'Wenn du das Kontaktformular verwendest, werden deine Angaben ausschließlich zur Bearbeitung deiner Anfrage genutzt und nicht an Dritte weitergegeben. Die Übertragung erfolgt über dein lokales E-Mail-Programm direkt an uns.', en: 'If you use the contact form, your details are used exclusively to process your request and are not passed on to third parties. Transmission occurs via your local email client directly to us.' },
  imp_privacy_ext:   { de: 'Externe Dienste:', en: 'External services:' },
  imp_privacy_txt3:  { de: 'Wir verlinken auf Discord, YouTube und TikTok. Beim Aufrufen dieser Seiten gelten deren jeweilige Datenschutzrichtlinien.', en: 'We link to Discord, YouTube and TikTok. When accessing these pages, their respective privacy policies apply.' },

  /* ════════ tutorials_cc.html ════════ */
  tcc_hero_desc:     { de: '10-teilige Lua-Tutorial-Serie für ComputerCraft. Von Hello World bis zu vollständigen GUIs – keine Vorkenntnisse nötig.', en: '10-part Lua tutorial series for ComputerCraft. From Hello World to full GUIs – no prior knowledge required.' },
  tcc_eyebrow:       { de: '▶ 10 TEILE', en: '▶ 10 PARTS' },
  tcc_title:         { de: 'Alle <span>Tutorials</span>', en: 'All <span>Tutorials</span>' },
  tcc_p1_sub:        { de: 'EINSTIEG', en: 'GETTING STARTED' },
  tcc_p1_body:       { de: 'Dein erstes Lua-Programm. Der edit-Editor, print() und die CraftOS-Shell.', en: 'Your first Lua program. The edit editor, print() and the CraftOS shell.' },
  tcc_p2_sub:        { de: 'GRUNDLAGEN', en: 'BASICS' },
  tcc_p2_body:       { de: 'local, string, number, boolean – Daten speichern und ausgeben.', en: 'local, string, number, boolean – storing and outputting data.' },
  tcc_p3_body:       { de: 'Strings verketten mit .., Rechenoperatoren, Variablen kombinieren.', en: 'Concatenating strings with .., math operators, combining variables.' },
  tcc_p4_sub:        { de: 'LOGIK', en: 'LOGIC' },
  tcc_p4_body:       { de: 'Entscheidungen treffen – Bedingungen, Vergleichsoperatoren, end.', en: 'Making decisions – conditions, comparison operators, end.' },
  tcc_p5_body:       { de: 'Mehrere Fälle, logische Operatoren, Wahrheitstabellen.', en: 'Multiple cases, logical operators, truth tables.' },
  tcc_p6_sub:        { de: 'KONTROLLFLUSS', en: 'CONTROL FLOW' },
  tcc_p6_body:       { de: 'true/false als Schalter, while-Schleife, for-Schleife, break.', en: 'true/false as switches, while loop, for loop, break.' },
  tcc_p7_sub:        { de: 'CC: TWEAKED API', en: 'CC: TWEAKED API' },
  tcc_p7_body:       { de: 'os.pullEvent, Tastatur- und Mausevents, Timer – auf alles reagieren.', en: 'os.pullEvent, keyboard and mouse events, timers – reacting to everything.' },
  tcc_p8_sub:        { de: 'NETZWERK', en: 'NETWORK' },
  tcc_p8_body:       { de: 'Computer vernetzen – senden, empfangen, broadcast, Protokolle.', en: 'Networking computers – send, receive, broadcast, protocols.' },
  tcc_p9_sub:        { de: 'DATENSTRUKTUREN', en: 'DATA STRUCTURES' },
  tcc_p9_body:       { de: 'Arrays, Key-Value, ipairs, pairs – Daten strukturieren.', en: 'Arrays, key-value, ipairs, pairs – structuring data.' },
  tcc_p10_sub:       { de: 'FINALE · GUI', en: 'FINALE · GUI' },
  tcc_p10_body:      { de: 'Farben, Formen zeichnen, term API, vollständiges GUI-Dashboard bauen.', en: 'Colors, drawing shapes, term API, building a full GUI dashboard.' },
  tcc_available:     { de: '✔ verfügbar', en: '✔ available' },
  tcc_finale:        { de: '✔ Finale', en: '✔ Finale' },
};
